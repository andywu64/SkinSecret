...
import com.aaron.skinsecret.ui.feature.community.latestnews.CommunityLatestNewsScreen
import com.aaron.skinsecret.ui.feature.community.popular.CommunityPopularScreen
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        ...
        Column(
            ...
            when (tabIndex) {
                ...
                0 -> CommunityPopularScreen(
                    navController = navController,
                    tabVM = tabVM
                )
                1 -> CommunityLatestNewsScreen(
                    navController = navController,
                    tabVM = tabVM
                )
            }
...
fun CommunityScreenPreview() {
    CommunityScreen(tabVM = viewModel())
}
